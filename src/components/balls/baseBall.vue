          ...
          <div v-if="items!=undefined && items!='' && maintanceCode!=='D000'">
              <div class="ball-detail-list"  v-for="(item,key,index) in items" :key="key">
                ...
                <transition name="fade">
                  ...
                  <div class="ball-detaill"  v-for="(itemDetail,indexT) in item" :key="indexT+'base'+itemDetail.id">
                    <!--内容-->
                      <div class="item-info">
                        <!--左-->
                          ...
                          <div class="content-detail" >
                            ...
                            <div class="all-alone-win">
                              ...
                              <div class="all-style" :class="{'checkedMix': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.dy + '0']}"
                                ...
                                <span :class="{'checkedMixPlant': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.dy + '0']}">主</span>
                              ...
                              <div class="all-style" :class="{'checkedMix': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.dy + '1']}"
                                ...
                                <span :class="{'checkedMixPlant': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.dy + '1']}">客</span>
                            ...
                            <div class="all-let-the-ball">
                              ...
                              <template >
                              <div class="all-style" :class="{'checkedMix': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.qcrq + (itemDetail.dStrong === 'H' ? '0' : '2')]}"
                                   @click="betDialogHandler(itemDetail,playType.host,playType.qcrq,'rqz',itemDetail.dIorRH)">
                                <span :class="[itemDetail.dStrong==='H' ? 'showitems' : 'hideitems']" >{{play[playType.qcrq]===undefined?' ':itemDetail.dRatio}}</span>
                                <span v-if="oddsSelect() === 'oddsCss1'" :class="oddsChangeClass(key, indexT,'dIorRH_change')">{{play[playType.qcrq]===undefined?'-':itemDetail.dIorRH != null ? formatOdds(itemDetail.dIorRH):'-'}}</span>
                                <span v-if="oddsSelect() === 'oddsCss2'" :class="oddsChangeClass(key, indexT,'dIorRH_change')">{{play[playType.qcrq]===undefined?'-':itemDetail.dIorRH != null ? formatOdds(itemDetail.dIorRH):'-'}}</span>
                                <span v-if="oddsSelect() === 'oddsCss2'" :class="oddsChangeTag(key, indexT,'dIorRH_change')"></span>
                              </div>
                              <div class="all-style" :class="{'checkedMix': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.qcrq + (itemDetail.dStrong === 'H' ? '1' : '3')]}"
                                   @click="betDialogHandler(itemDetail,!playType.host,playType.qcrq,'rqk',itemDetail.dIorRC)">
                                <span :class="[itemDetail.dStrong==='C' ? 'showitems' : 'hideitems']" >{{play[playType.qcrq]===undefined?' ':itemDetail.dRatio}}</span>
                                <span v-if="oddsSelect() === 'oddsCss1'" :class="oddsChangeClass(key, indexT,'dIorRC_change')">{{play[playType.qcrq]===undefined?'-':itemDetail.dIorRC != null ? formatOdds(itemDetail.dIorRC):'-'}}</span>
                                <span v-if="oddsSelect() === 'oddsCss2'" :class="oddsChangeClass(key, indexT,'dIorRC_change')">{{play[playType.qcrq]===undefined?'-':itemDetail.dIorRC != null ? formatOdds(itemDetail.dIorRC):'-'}}</span>
                            ...
                            <div class="all-size">
                              ...
                              <div class="all-style" :class="{'checkedMix': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.qcdx + '0']}"
                                   @click="betDialogHandler(itemDetail,playType.host,playType.qcdx,'dxz',itemDetail.dIorOUH)">
                                <span>{{play[playType.qcdx]===undefined?' ':itemDetail.dRatioO}}</span>
                                <span v-if="oddsSelect() === 'oddsCss1'" :class="oddsChangeClass(key, indexT,'dIorOUH_change')">{{play[playType.qcdx]===undefined?'-':itemDetail.dIorOUH != null ? formatOdds(itemDetail.dIorOUH):'-'}}</span>
                                <span v-if="oddsSelect() === 'oddsCss2'" :class="oddsChangeClass(key, indexT,'dIorOUH_change')">{{play[playType.qcdx]===undefined?'-':itemDetail.dIorOUH != null ? formatOdds(itemDetail.dIorOUH):'-'}}</span>
                              ...
                              <div class="all-style" :class="{'checkedMix': checkedMatches[itemDetail.onlykey + itemDetail.matchesDetailId + playType.qcdx + '1']}"
                                   @click="betDialogHandler(itemDetail,!playType.host,playType.qcdx,'dxk',itemDetail.dIorOUC)">
                                <span></span>
                                <span v-if="oddsSelect() === 'oddsCss1'" :class="oddsChangeClass(key, indexT,'dIorOUC_change')">{{play[playType.qcdx]===undefined?'-':itemDetail.dIorOUC != null ? formatOdds(itemDetail.dIorOUC):'-'}}</span>
                                <span v-if="oddsSelect() === 'oddsCss2'" :class="oddsChangeClass(key, indexT,'dIorOUC_change')">{{play[playType.qcdx]===undefined?'-':itemDetail.dIorOUC != null ? formatOdds(itemDetail.dIorOUC):'-'}}</span>
...
<script src="../../js/balls/baseBall.js"></script>
